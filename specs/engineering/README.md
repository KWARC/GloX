...
How we implement PRDs with the **current** stack (vendors, code paths, data contracts).

| Area | Location |
| --- | --- |
| Tech specs (SDDs) | [features/](./features/) — critical areas, EARS rules |
| Decisions (`D-*`) | [decisions/](./decisions/) — locked engineering choices + rationale |
| External deps (`E-*`) | [external-deps/](./external-deps/) — vendor compliance + library quirks |
